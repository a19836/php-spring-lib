...
include_once get_lib("sqlmap.SQLMap");
include_once get_lib("xmlfile.XMLFileParser");
include get_lib("sqlmap.exception.SQLMapClientException");
include get_lib("sqlmap.IRDBBroker");
...
class SQLMapClient extends SQLMap {
	...
	public function setRDBBroker(IRDBBroker $RDBBroker) {$this->RDBBroker = $RDBBroker;}
