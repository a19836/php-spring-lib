...
include get_lib("sqlmap.hibernate.HibernateClientCache");
include get_lib("sqlmap.hibernate.HibernateClassHandler");
include get_lib("sqlmap.hibernate.IHibernateClientCacheLayer");
include get_lib("sqlmap.hibernate.exception.HibernateException");
...
class HibernateClient extends SQLMapClient {
	...
	public static function getHibernateObjectNodeConfiguredFromFilePath($obj_path, $external_vars = false) {
		$xml_schema_file_path = get_lib("xmlfile.schema.hibernate_sql_mapping", "xsd");
