...
include_once get_lib("memcache.exception.MemcacheException");
include_once get_lib("memcache.IMemcacheHandler");
include_once get_lib("vendor.memcache.NSMemcache");
