...
//include_once get_lib("phpscript.PHPUICodeExpressionHandler");
...
class HashTagParameter {
	 ...
	 *  - app/lib/workflow/task/programming/common/webroot/js/PTLFieldsUtilObj.js
	 *  		/#([\w\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u024F\u1EBD\u1EBC"' \-\+\[\]\.\$]+)#/g
	 ...
	 * 	grep -r "#" app/lib/ app/__system/layer/presentation/phpframework/ | grep '\\w' | grep -v "/cache" | grep -v "/vendor/" | grep -v "/docbook/" | grep -v "\.ser$" | grep "\#"
	 */
