...
include_once get_lib("sqlmap.exception.SQLMapQueryException");
include_once get_lib("object.ObjectHandler");
include_once get_lib("object.ObjTypeHandler");
include_once get_lib("util.HashTagParameter");
